...
#define TEMPO_CC 4
#define CHORD_CC 5
#define CHANNEL_CC 6 //**TP** Note that channel switching was taken out since I don't use it
...
//**TP** This eats up the last possible program change values, 6E and 6F
